...
int main(int argc, char const* argv[]) {
  ...
  if (tipo1 == 'p') {
    ...
    for (i = 0; i < nocoef; i++) {
      ponteiro1[1][i].denominador = scanf("%hd ", &ponteiro1[0][i].denominador);
    }
    ...
    for (i = 0; i < nocoef; i++) {
      ponteiro1[0][i].denominador = scanf("%hd ", &ponteiro1[0][i].denominador);
    }
    for (j = 0; j < nocoef; j++) {
      ponteiro1[1][j].numerador = scanf("%hd ", &ponteiro1[0][j].numerador);
    }
    for (j = 0; j < nocoef; j++) {
      ponteiro1[1][j].denominador = scanf("%hd ", &ponteiro1[0][j].denominador);
    }
  }
  ...
  if (tipo2 == 'p') {
    ...
    for (i = 0; i < nocoef; i++) {
      ponteiro2[1][i].denominador = scanf("%hd ", &ponteiro2[0][i].denominador);
    }
  } else {
    ...
    for (i = 0; i < nocoef; i++) {
      ponteiro2[0][i].denominador = scanf("%hd ", &ponteiro2[0][i].denominador);
    }
    for (j = 0; j < nocoef; j++) {
      ponteiro2[1][j].numerador = scanf("%hd ", &ponteiro2[0][j].numerador);
    }
    for (j = 0; j < nocoef; j++) {
